        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-up">
                ...
                <div class="col-md-7 pt-4">
                    ...
                    <ul>
                        <li>
                            <i class="icofont-check"></i> Ullamco laboris nisi
                            ut aliquip ex ea commodo consequat.
                        </li>
                        <li>
                            <i class="icofont-check"></i> Duis aute irure dolor
            ...
            <div class="row" data-aos="fade-up">
                ...
                <div class="col-md-7 pt-5">
                    ...
                    <ul>
                        ...
                        <li>
                            <i class="icofont-check"></i> Facilis ut et
                            voluptatem aperiam. Autem soluta ad fugiat.
                        </li>
                    </ul>
                </div>
            </div>
